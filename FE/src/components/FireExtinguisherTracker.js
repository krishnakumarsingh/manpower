                            ...
                            data.map(
                                employee =>
                                    <tr key={employee.id}>
                                        ...
                                        <td>{employee.assetNo}</td>
                                        <td>{employee.calibrationDate}</td>
                                        <td>{employee.calibartionDueDate}</td>
                                        <td>{employee.status}</td>
                                        <td>{employee.issuedTo}</td>
                                        <td>{employee.remarks}</td>
                                        <td>{employee.asOnDated}</td>
                                    </tr>
                            )
                        }
                    </tbody>
                    ...
                    <Form onSubmit={submitData}>
                        <div className='form-wrapper'>
                            ...
                            <Form.Group className="col-md-5 mb-3" controlId="calibrationDate">
                                <Form.Control type="text" placeholder="Calibration Date" />
                            </Form.Group>

                            <Form.Group className="col-md-5 mb-3" controlId="calibartionDueDate">
                                <Form.Control type="text" placeholder="Calibartion Due Date" />
                            </Form.Group>
